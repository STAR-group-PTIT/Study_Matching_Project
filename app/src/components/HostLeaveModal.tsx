      ...
      >
        {step === 'choose' ? (
          <>
            ...
            {error && (
              <p className="m-0 rounded-[16px] px-[13px] py-[10px] text-[12.5px] font-semibold text-[var(--c-5nx3vn)]" style={{ background: 'var(--c-11cq831)' }}>
            ...
            <div className="flex flex-col gap-[9px]">
              ...
              >
                <span className="text-[14.5px] font-extrabold text-[var(--c-5nx3vn)]">{t('room.hostLeave.closeTitle')}</span>
                <span className="text-[12.5px] font-semibold text-[var(--c-2s3160)]">{t('room.hostLeave.closeDesc')}</span>
              </button>
              <button
              ...
              >
                <span className="text-[14.5px] font-extrabold text-[var(--c-2vtjkg)]">{t('room.hostLeave.transferTitle')}</span>
                <span className="text-[12.5px] font-semibold text-[var(--c-hxgb90)]">
